                            ...
                            <tr>
                                <td class="bg_white email-section" style="padding-top:0;">
                                    <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                        ...
                                        {{-- <div style="margin: 40px 0;">
                                            <a href="verfication_link" class="btn btn-primary" style="padding: 15px 30px; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 8px; display: inline-block;">
                                                Verify My Email
                                            </a>
                                        </div> --}}
                                        ...
                                        {{-- <div style="margin-top: 40px; padding-top: 30px; border-top: 1px solid #e5e7eb;">
                                            ...
                                            <p style="color: #6366f1; font-size: 14px; word-break: break-all; margin: 15px 0;">
                                                verfication_link
                                            </p>
                                        </div> --}}
